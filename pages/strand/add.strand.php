...
<head>
    ...
    <title>Add Strand | BED Taguig</title>
                            ...
                            <div class="card">
                                <form action="userData/ctrl.add.strand.php" enctype="multipart/form-data" method="POST">
                                    <div class="card-header">
                                        <h3 class="card-title">Add Strand</h3>
                                        ...
                                        <div class="row mb-4 mt-4">
                                            <div class="input-group col-sm-6 mb-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text text-sm"><b>Strand abr.
                                                            </b></span>
                                                    </div>
                                                    <input type="text" class="form-control" name="strand_name"
                                                    placeholder="Enter Strand Abbreviation">
                                            </div>
                                            <div class="input-group col-sm-6 mb-2">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" name="strand_def"s
